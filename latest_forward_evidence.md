...
The ledger is empty or nothing on it has settled. Before the season starts this is the correct state, not a fault: forward evidence can only begin accumulating when books post prices and games produce results.
