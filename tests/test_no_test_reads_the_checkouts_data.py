...
CHECKOUT_SENSITIVE_TESTS: tuple[str, ...] = (
    ...
    "tests/test_a_failed_events_listing_is_a_failed_per_event_fetch.py::test_a_stale_per_event_file_is_replaced_not_left_beside_fresh_team_prices",
    "tests/test_a_failed_events_listing_is_a_failed_per_event_fetch.py::test_no_credential_reaches_anything_the_run_prints_or_writes",
    "tests/test_a_failed_events_listing_is_a_failed_per_event_fetch.py::test_the_run_health_names_the_per_event_fetch",
    "tests/test_a_failed_fetch_never_reads_as_an_absent_market.py::test_books_that_quoted_nothing_still_read_as_absent",
    "tests/test_a_failed_per_event_fetch_is_a_degraded_run.py::test_books_that_quoted_nothing_are_not_a_failure",
