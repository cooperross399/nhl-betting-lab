...
price evidence for the regulation three-way, which no book retains
historically, and the accumulating out-of-sample test for every market and
every shipped policy at once. (Hits was once named beside the three-way here;
...
def render_forward_report(payload: dict) -> str:
    ...
    lines = [
        ...
        (
            ...
            "three-way, which no book retains historically, and the "
            "accumulating out-of-sample test for everything else."
        ),
        "",
